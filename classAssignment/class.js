...
//console.log()
//console.log(classFunctions.addStudent(schoolClass,"Lasar", 103 ))
//console.log(classFunctions.sortByMarks(schoolClass, subject = 'english'))
...
// detailsCopy.students.sort((a, b) => a.name.localeCompare(b.name))
// console.log(detailsCopy)
//const response = 10;
// let studentsArray = detailsCopy.students;
...
if (response === 1) {
    ...
    studentsMarksArray = inputFunctions.readSubjectMarksMultiple(schoolClass)
    ...
    if (studentNewMarkDetails != undefined) {
        studentEdited = classFunctions.editMarkSubjectStudent(schoolClass, studentNewMarkDetails.id, studentNewMarkDetails.subject, studentNewMarkDetails.newMark);
    ...
    removeSubjectArray = removeSubject(schoolClass,subjectToRemove);
    ...
    if (sortCriteria === "name") console.log(sortByName(schoolClass).students);
        ...
        sortedStudents = sortByMarks(schoolClass, subject).students
...
//     id: 105, 
//     marks: [
//        {subject: "english", mark : 99},
//        {subject: "maths", mark : 89}
//         ]
//     }
//     detailsCopy.students.push(newStudent)

//console.log(detailsCopy.students)
// console.log(importFunctions.testFunction())